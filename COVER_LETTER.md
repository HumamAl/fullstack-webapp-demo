...
Previously built a 6-module Fleet Maintenance SaaS with complex relational data and role-based views from scratch to production.

Is the Spring Boot layer handling business logic only, or are there Node.js microservices running alongside it for specific domains?
